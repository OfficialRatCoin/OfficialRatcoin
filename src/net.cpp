...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Ratcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"node1.Ratcoin.info", "node1.Ratcoin.info"},
    {"node2.Ratcoin.info", "node2.Ratcoin.info"},
    {"node3.Ratcoin.info", "node3.Ratcoin.info"},
    {"node4.Ratcoin.info", "node4.Ratcoin.info"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Ratcoin is probably already running."), addrBind.ToString().c_str());
        else
