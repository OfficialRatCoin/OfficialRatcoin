...
unsigned int nStakeMinAge = 60 * 60 * 24;	// minimum age for coin age: 1
...
int64 nChainStartTime = 1400400485;
...
const string strMessageMagic = "Ratcoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Ratcoin
    bool fStrictPayToScriptHash = true; // Always active in Ratcoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Ratcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "1400400485";
        CTransaction txNew;
       ...
       if ( false  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("94d4a33e57a343a0f27bdc242ec9a0392fcac99c2e01e3087bcb7569a5f522b7"));
...
// The characters are rarely used upper RATCII, not valid as UTF-8, and produce
